...
embargos = 'D:\\UFPI_2024_2025\\2W CURSO\\mba_dashboards\\Dados\\embargos_ibama.parquet'
desmatamentos = 'D:\\UFPI_2024_2025\\2W CURSO\\mba_dashboards\\Dados\\prodes.parquet'
tis = 'D:\\UFPI_2024_2025\\2W CURSO\\mba_dashboards\\Dados\\tis.parquet'
...
if poligono_subido:
    ...
    with MemoryFile(raster_subido.getvalue()) as memfile:
        with memfile.open() as src:
            ...
            if poligono_analise.crs != src.crs: poligono_analise = poligono_analise.to_crs(src.crs)
